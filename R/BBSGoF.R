...
if((B[j]-A[j])==0){l2[j]=0} else {l2[j]<-sum(log(1-pe+(-rho/(rho-1))*(0:(B[j]-A[j]-1))))}
}
return(sum(l2))}
...
for(j in 1:length(A)){
if(A[j]==0){l111[j]=0} else {l111[j]<-sum((-1)/((pe+(-rho/(rho-1))*(0:(A[j]-1)))^2))}
}
return(sum(l111))}
...
for(j in 1:length(B-A)){
if((B[j]-A[j])==0){l112[j]=0} else {l112[j]<-sum((-1)/((1-pe+(-rho/(rho-1))*(0:(B[j]-A[j]-1)))^2))}
}
return(sum(l112))}
...
for(j in 1:length(A)){
if(A[j]==0){l121[j]=0} else {l121[j]<-sum((-(0:(A[j]-1)))/((pe+(-rho/(rho-1))*(0:(A[j]-1)))^2))}
}
return(sum(l121))}
...
for(j in 1:length(B-A)){
if((B[j]-A[j])==0){l122[j]=0} else {l122[j]<-sum((0:(B[j]-A[j]-1))/((1-pe+(-rho/(rho-1))*(0:(B[j]-A[j]-1)))^2))}
}
return(sum(l122))}
...
for(j in 1:length(A)){
if(A[j]==0){l221[j]=0} else {l221[j]<-sum((-((0:(A[j]-1))^2))/((pe+(-rho/(rho-1))*(0:(A[j]-1)))^2))}
}
return(sum(l221))}
...
for(j in 1:length(B-A)){
if((B[j]-A[j])==0){l222[j]=0} else {l222[j]<-sum((-((0:(B[j]-A[j]-1))^2))/((1-pe+(-rho/(rho-1))*(0:(B[j]-A[j]-1)))^2))}
}
return(sum(l222))}
...
for(j in 1:length(B)){
if((B[j])==0){l223[j]=0} else {l223[j]<-sum(((0:(B[j]-1))^2)/((1+(-rho/(rho-1))*(0:(B[j]-1)))^2))}
}
return(sum(l223))}
...
nI<-matrix(-1*c(der11(prob[i],ro[i]),der12(prob[i],ro[i]),der12(prob[i],ro[i]),der22(prob[i],ro[i])),nrow=2,ncol=2)
nnI[[i]]<-nI
...
if(vb1[i]<0) sb1[i]<-0 else sb1[i]=sqrt(vb1[i])
...
if((B[i]-A[i])==0){l2[i]=0} else {l2[i]<-sum(log(1-pe+(-rho/(rho-1))*(0:(B[i]-A[i]-1))))}
}
return(sum(l2))}
...
L3<-function(pe,rho){
for(i in 1:length(A)){
if(B[i]==0){l1[i]=0} else {l3[i]<-sum(log(1+(-rho/(rho-1))*(0:(B[i]-1))))}
}
return(sum(l3))}
...
L111<-function(pe,rho){
for(i in 1:length(A)){
if(A[i]==0){l111[i]=0} else {l111[i]<-sum((-1)/((pe+(-rho/(rho-1))*(0:(A[i]-1)))^2))}
}
return(sum(l111))}
...
L112<-function(pe,rho){
for(i in 1:length(B-A)){
if((B[i]-A[i])==0){l112[i]=0} else {l112[i]<-sum((-1)/((1-pe+(-rho/(rho-1))*(0:(B[i]-A[i]-1)))^2))}
}
return(sum(l112))}
...
L121<-function(pe,rho){
for(i in 1:length(A)){
if(A[i]==0){l121[i]=0} else {l121[i]<-sum((-(0:(A[i]-1)))/((pe+(-rho/(rho-1))*(0:(A[i]-1)))^2))}
}
return(sum(l121))}
...
L122<-function(pe,rho){
for(i in 1:length(B-A)){
if((B[i]-A[i])==0){l122[i]=0} else {l122[i]<-sum((0:(B[i]-A[i]-1))/((1-pe+(-rho/(rho-1))*(0:(B[i]-A[i]-1)))^2))}
}
return(sum(l122))}
...
L221<-function(pe,rho){
for(i in 1:length(A)){
if(A[i]==0){l221[i]=0} else {l221[i]<-sum((-((0:(A[i]-1))^2))/((pe+(-rho/(rho-1))*(0:(A[i]-1)))^2))}
}
return(sum(l221))}
...
L222<-function(pe,rho){
for(i in 1:length(B-A)){
if((B[i]-A[i])==0){l222[i]=0} else {l222[i]<-sum((-((0:(B[i]-A[i]-1))^2))/((1-pe+(-rho/(rho-1))*(0:(B[i]-A[i]-1)))^2))}
}
return(sum(l222))}
...
L223<-function(pe,rho){
for(i in 1:length(B)){
if((B[i])==0){l223[i]=0} else {l223[i]<-sum(((0:(B[i]-1))^2)/((1+(-rho/(rho-1))*(0:(B[i]-1)))^2))}
}
return(sum(l223))}
...
nI<-matrix(-1*c(der11(prob[j],ro[j]),der12(prob[j],ro[j]),der12(prob[j],ro[j]),der22(prob[j],ro[j])),nrow=2,ncol=2)
nnI[[j]]<-nI
}


beta1<-sapply(jmin:jmax,function(j) beta1<-log(prob[j]/(1-prob[j])))
beta2<-sapply(jmin:jmax,function(j) beta2<-log(ro[j]/(1-ro[j])))

varp<-sapply(jmin:jmax,function(i) varp<-solve(matrix(nnI[[i]],2,2))[1,1])
varo<-sapply(jmin:jmax,function(i) varo<-solve(matrix(nnI[[i]],2,2))[2,2])
...
Zvalue<-sapply(jmin:jmax,function(j) Zvalue<-(S[j]-sum(BB[[j]]))/sqrt(2*sum(BB[[j]]*(BB[[j]]-1))))
